...
| [TanStack Query and One Fat Store](/store/examples/tanstack-query-fat-store)           | Splitting client-owned state (Kin Store) from server-owned state (React Query), as a single store with methods.             |
